...
function generateImagePrompt(title, organization, category) {
  return {
    prompt: `Editorial city street photo about community support in the ${category.replace(/-/g, ' ')} category. Documentary urban streetscape, natural light, candid realism, respectful hopeful mood. Rich black and white with exactly one prominent element in one primary color: red, blue, or yellow. ZERO TEXT OR TEXT-LIKE MARKS: no title, organization name, letters, words, numbers, captions, logos, branding, storefront lettering, signs, posters, ads, labels, packaging text, license plates, watermarks, or signatures, including blurred, partial, invented, or illegible writing. Avoid surfaces that normally display writing. No specific facility, identifiable vulnerable person, or staged poverty.`,
