...
function generateImagePrompt(title, organization, category) {
  return {
    prompt: `Documentary urban street photo representing community support in the ${category.replace(/-/g, ' ')} category. Natural light, candid realism, respectful hopeful mood. Rich black and white with exactly one prominent red, blue, or yellow element. Every visible surface is blank and unmarked. The image contains no text, letters, numbers, logos, signs, labels, packaging, or watermarks.`,
