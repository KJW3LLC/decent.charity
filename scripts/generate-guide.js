...
function generateImagePrompt(topic) {
  return {
    prompt: `Editorial city street photograph illustrating community support in the ${topic.category.replace(/-/g, ' ')} category. Documentary-style urban streetscape connected to neighborhood life. Render the entire photo in rich black and white except for one single prominent element in one primary color (red, blue, or yellow). Natural light, candid realism, strong composition, respectful and hopeful mood. ABSOLUTE REQUIREMENT: the image must contain zero text-like content. Do not show the article title, organization name, letters, words, numbers, captions, typography, logos, branding, storefront lettering, street signs, posters, advertisements, labels, packaging text, license plates, watermarks, or signatures—even blurred, partial, invented, or illegible. Avoid surfaces or objects where writing would normally appear. Do not depict or imply a specific facility, client, volunteer, or branded property. No staged poverty imagery.`,
